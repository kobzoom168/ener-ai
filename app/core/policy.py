...
TASK_MODEL_MAP = {
    ...
    # Security / no-filter → Featherless uncensored (dolphin ต้องการ Ollama local ซึ่งมักไม่พร้อม)
    "security":       "featherless-abliterated",
    "hacking":        "featherless-abliterated",
    "exploit":        "featherless-abliterated",
    "uncensored":     "featherless-abliterated",
    "news":           "gemini-flash-lite",
    "newsdiscovery":  "haiku",
    "gmail":          "gemini-flash-lite",
    "vision":         "gemini-flash-lite",
    # Code → Featherless Qwen2.5 Coder 32B (ตัวเก่งสุดสำหรับ code, unlimited token)
    "code":           "featherless-coder",
    # Brainstorm / reasoning → Qwen3 32B
    "brainstorm":     "featherless-qwen3",
    ...
    "memorycurator":  "haiku",
    "briefing":       "featherless-deepseek",
    "github":         "featherless-coder",
    "tarot":          "haiku",
    "content":        "gemini-flash-lite",
    "ener":           "haiku",
    "mainagent":      "featherless-deepseek",
