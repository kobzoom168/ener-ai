...
async def generate_story(topic: str, n_shots: int = 8, characters: int = 2,
    ...
    prompt = (
        ...
        + ("โหมดละครพูด (แบบ shot-reverse-shot เหมือนละครจริง):\n"
           ...
           "- **image_prompt ของช็อตพูด = close-up/medium close-up หน้าตัวละครคนนั้น 'คนเดียวในเฟรม'** "
           "หันหน้าเฉียง 3/4 มองไปทางคู่สนทนา เห็นหน้าชัด (ห้ามใส่ 2 คนในเฟรมเดียวตอนพูด ห้ามหันหน้าตรงจ้องกล้อง)\n"
