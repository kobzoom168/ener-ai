...
**ภาพต้องเข้ากับบทเป๊ะ (สำคัญมาก):** image_prompt ของแต่ละช็อตต้อง "ตรงกับสิ่งที่พูด/เล่าในช็อตนั้นเป๊ะ" — สีหน้า/ท่าทาง/แอ็กชัน/บรรยากาศในภาพ ต้องสื่ออารมณ์และเหตุการณ์ของบทช็อตนั้น (เช่น บทพูดตกใจ→หน้าตกใจ, บทเผยความจริง→สีหน้าสะเทือนใจ) ให้คนดูภาพแล้วเข้าใจว่ากำลังเกิดอะไร
